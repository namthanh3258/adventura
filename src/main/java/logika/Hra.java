...
public class Hra implements IHra {
    ...
    public String vratUvitani() {
        ...
        return "Vítejte!\n" +
               "Tvé království bylo napadeno zlým černokněžníkem jménem Gul’Dan a jeho stoupenci, během útoku také byla unesena princezna.\n" +
                "Byl si tedy králem pověřen, aby si Gul’Dana porazil a princeznu bezpečně dovedl zpátky domů.\n" +
                "Nebude to, ale tak jednoduché, na cestě k němu tě bude čekat spousta nebezpečí, se kterýma se budeš muset vypořádat.\n" +
